...
SECRET_KEY = 'django-insecure-m9*f48y2pi4k15vo($tme^ofnj^-+_)_*t84-p@cv0x3j0o_73'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'SOCIAL.DEV API',
    'DESCRIPTION': 'Documentação da API da mini rede social SOCIAL.DEV',
    'VERSION': '1.0.0',
